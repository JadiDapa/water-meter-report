...
function InfoCard({
  ...
  return (
    <div
      className={cn(
        "flex items-start gap-4 rounded-xl border bg-white p-5 ring-1 dark:bg-neutral-900",
        c.ring,
      )}
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="mb-1 text-xs font-medium tracking-widest text-neutral-400 uppercase">
          {label}
        </p>
        <p className="truncate text-[15px] font-semibold text-neutral-800 dark:text-neutral-100">
          {name}
        </p>
        <span className={cn("mt-1 inline-block rounded-md px-2 py-0.5 text-xs font-medium", c.badge)}>
          @{username}
        </span>
      </div>
    </div>
  ...
  return (
    <div className="rounded-xl border bg-white p-5 ring-1 ring-sky-200 dark:bg-neutral-900 dark:ring-sky-800">
      <div className="mb-5 flex items-center gap-2.5">
        <div className="rounded-lg bg-sky-50 p-2.5 dark:bg-sky-950">
